...
public class CrimeListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container
        ...
        // Add button
        mButton =view.findViewById(R.id.crime_empty_button);
        ...
        // TextView
        mTextView =view.findViewById(R.id.crime_empty);
        updateUI();
        return view;
    }
    ...
    // 提取的重复检查的是否存在crime，提取出来的方法
    private void checkVisibilty(Button mButton , TextView mText) {
        int visibilty = isCrimesEmpty(CrimeLab.get(getActivity()));
        if (mButton != null) {
    ...
    private int isCrimesEmpty(CrimeLab crimeLab) {
    ...
    private void updateUI() {
        ...
        // always check is or not have crime;
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            // 创建一个Intent实例用来调用，CrimeActivity活动组建。
            // CrimePagerActivity类中获取了Intent对象，
            // 通过包装Intent的构造器，通过调用newIntent方法产生了intent实例。
